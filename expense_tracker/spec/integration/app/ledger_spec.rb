...
# require_relative '../../support/db.rb' #<--removed as lines were added to spec_helper to provide this
...
module ExpenseTracker
  RSpec.describe Ledger, :aggregate_failures, :db do
    ...
    describe '#expenses_on' do
      ...
      it 'returns a blank array when there is no matching expenses' do
        expect(ledger.expenses_on('2016-06-10')).to eq([])
      end
    end
